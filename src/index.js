...
//toggle modal fn
import { showTeamModal } from './js/utils/modal-team.js';
...
const GOIT_STUDENTS_LINK = document.querySelector('.goit-students');
...
GOIT_STUDENTS_LINK.addEventListener('click', showTeamModal);
